...
public class DonacionesExitosas extends Mision{
    ...
    public DonacionesExitosas(String id, String nombre, String insigniaId, CategoriaDonadorEnum categoriaDonadorFin, CategoriaDonadorEnum categoriaDonadorInicio, TipoMisionEnum tipoDeMision) {
